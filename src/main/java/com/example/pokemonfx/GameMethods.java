...
public class GameMethods {
    ...
    public static void game() {
        ...
        switch (starter) {
            case 1:
                player.addMon(bulbasaur);
                opponent.addMon(squirtle);
                break;
            case 2:
                player.addMon(charmander);
                opponent.addMon(bulbasaur);
                break;
            case 3:
                player.addMon(squirtle);
                opponent.addMon(charmander);
                break;
        }
        ...
        boolean result = battle(player, opponent);
        ...
        if (result){
            ...
            player.addMon(playerMons[0][choice-1]);
            ...
            opponent.addMon(opponentMons[0][opponentChoice]);
            ...
            if (result) {
                ...
                player.addMon(playerMons[1][choice - 1]);
                playerMons[1][choice - 1] = none;
                ...
                opponent.addMon(opponentMons[1][opponentChoice]);
                opponentMons[1][opponentChoice] = none;
                ...
                if (result) {
                    ...
                    if (result){
                        ...
                        if (result) {
                            ...
                            player.addMon(legendaries[choice - 1]);
                            ...
                            opponent.addMon(legendaries[opponentChoice]);
            ...
            if (playerHP <= 0) {
                ...
                if (totalPlayerHP > 0) {
                    ...
                    try {   //get a valid user input
                        do {
                            monPlayer = input.nextInt();
                        } while (monPlayer < 1 || monPlayer > 6 || player.getMons().get(monPlayer - 1).getHP() == 0);
                    }
